...
Revision ID: cbf0643400a2
Revises: 
Create Date: 2026-03-23 20:54:29.585149
...
def upgrade() -> None:
    ...
    #op.create_index('idx_chamadas_coordenadas_professor', 'chamadas', ['coordenadas_professor'], unique=False, postgresql_using='gist')
    ...
    #op.create_index('idx_presencas_coordenadas_aluno', 'presencas', ['coordenadas_aluno'], unique=False, postgresql_using='gist')
